...
/**
 * @brief read an interger from console
 * @return int
*/
int ReadNum();

/**
 * @brief print an interger to console
 * 
 ...
 * 
 * @param buffer address of array to store readed string
 * @param max_length number of char can stored in buffer, include '/0'
 * @return char*
*/
char* ReadString(char* buffer, int max_length);
...
/**
 * @brief: read a char from console
 * @return char
*/
char ReadChar();

/**
 * @brief: print a char to console
 * @return void
*/
